...
const LoginScreen = () => {
    ...
    // useRef to pull login data (username and password)
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <form style={{ marginTop: '2rem' }}>
                            ...
                            <button type="button" className="btn btn-primary btn-lg interFont2 p-3 px-4" style={{ marginTop: '2rem' }}>Login</button>
                            <p className="mt-2">
